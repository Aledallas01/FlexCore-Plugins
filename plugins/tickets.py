...
from tickets import create_ticket, close_ticket, delete_ticket, claim_ticket, move_ticket
from .views import TicketPanelView, TicketControlsView, ConfirmationView, ReasonModal
...
class TicketsCog(commands.Cog):
    ...
    @app_commands.command(name="move", description="Move the ticket to another category")
    @app_commands.checks.has_permissions(manage_channels=True)
    async def ticket_move(self, interaction: discord.Interaction, category: discord.CategoryChannel):
